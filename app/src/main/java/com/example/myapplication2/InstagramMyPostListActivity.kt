...
import kotlinx.android.synthetic.main.activity_instagram_my_post_list.*
...
class InstagramMyPostListActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_instagram_my_post_list)
        ...
        user_info.setOnClickListener {
            startActivity(Intent(this@InstagramMyPostListActivity, InstagramUserInfo::class.java))
        }

      all_list.setOnClickListener {
            startActivity(
                Intent(this@InstagramMyPostListActivity, InstagramPostListActivity::class.java)
            )
        }

        upload.setOnClickListener {
            startActivity(
                Intent(this@InstagramMyPostListActivity, InstagramUploadActivity::class.java)
            )
        }
            ...
            .enqueue(object : Callback<ArrayList<Post>> {
                override fun onResponse(
                    ...
                    if (response.isSuccessful) {
                        ...
                        val adapter = MyPostAdapter(myPostList!!, LayoutInflater.from(this@InstagramMyPostListActivity), glide)
